...
import test.Person
import test.java.success.core.method.style.named.order.OnlyOrderByDao
import test.java.success.core.method.style.named.order.OrderWithMultipleColumnDao
import test.java.success.core.method.style.named.order.QueryWithSingleColumn
...
class OrderTest : BaseTest() {
    ...
    fun onlyOrderBy() {
        ...
        val impl = getJavaDaoInstance<OnlyOrderByDao>()
